      ...
      if (navigator.geolocation) {
        ...
        navigator.geolocation.getCurrentPosition(
          ...
          function(position) {
            ...
            ?key=AIzaSyB8JS5diZ8zIEUkoapu9qp_fVAVihF1C_M'+
            '&types=shopping_mall|meal_takeaway|liquor_store|grocery_or_supermarket|food|convenience_store'+
            '&rankby=distance&location=' + position.coords.latitude + ',' + position.coords.longitude +
            '&language=ja&keyword='+ shop_name)
