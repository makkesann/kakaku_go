    ...
    googleapi(shop_name){
      ...
      if (navigator.geolocation) {
        ...
        navigator.geolocation.getCurrentPosition(
          ...
          function(position) {
            // 緯度・経度を変数に格納?
            axios.get('https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/place/nearbysearch/json?key=AIzaSyB8JS5diZ8zIEUkoapu9qp_fVAVihF1C_M&types=shopping_mall|meal_takeaway|liquor_store|grocery_or_supermarket|food|convenience_store&rankby=distance&location=' + position.coords.latitude + ',' + position.coords.longitude + '&language=ja&keyword='+ shop_name)
