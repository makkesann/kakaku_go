    ...
    googleapi(shop_name){
      ...
      if (navigator.geolocation) {
        ...
        navigator.geolocation.getCurrentPosition(
          ...
          function(position) {
            // 緯度・経度を変数に格納?
            axios.get('https://maps.googleapis.com/maps/api/place/nearbysearch/json?key=AIzaSyB8JS5diZ8zIEUkoapu9qp_fVAVihF1C_M&rankby=distance&location=' + position.coords.latitude + ',' + position.coords.longitude + '&language=ja&keyword='+ shop_name)
